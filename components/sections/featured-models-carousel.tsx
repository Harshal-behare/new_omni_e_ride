      ...
      <CardContent className="space-y-3">
        ...
        <div className="grid grid-cols-2 gap-3 py-2">
          <div className="bg-gray-50 rounded-lg p-2 text-center">
            <div className="text-xs text-gray-600 mb-1">Charging Time</div>
            <div className="text-lg font-bold text-gray-900">{vehicle.charging_time_hours} hrs</div>
          </div>
          <div className="bg-gray-50 rounded-lg p-2 text-center">
        ...
        <div className="flex items-center justify-center gap-2 text-sm text-gray-600">
          ...
          <span>Battery: {vehicle.range_km > 100 ? 'Lithium-ion' : 'Lead-acid'}</span>
        </div>
