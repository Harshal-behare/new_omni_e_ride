        ...
        <div className="grid gap-8 md:grid-cols-3 lg:grid-cols-4">
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm text-gray-400">
              OMNI E-RIDE is committed to building a sustainable future with
              innovative electric scooters designed for modern city life.
            </p>
            <div className="text-sm">
              ...
              <address className="not-italic flex items-start gap-2">
                ...
                <a
                  href="https://maps.app.goo.gl/dETpCys9fYfMQAyeA"
                  target="_blank"
              ...
              <div>
                Email:{" "}
                <a
                  href="mailto:support@omnideride.com"
                  className="text-emerald-400 hover:underline"
                >
                  support@omnideride.com
                </a>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="mb-4 flex gap-3">
              <a
                ...
                href="https://www.instagram.com/omni_eride/"
                target="_blank"
                rel="noopener noreferrer"
              ...
              <a
                aria-label="Facebook"
                href="https://www.facebook.com/profile.php?id=61570865410071"
                target="_blank"
                rel="noopener noreferrer"
                className="hover:text-emerald-400"
              >
              ...
              <a
                aria-label="YouTube"
                href="https://www.youtube.com/@Omnieride"
                target="_blank"
                rel="noopener noreferrer"
                className="hover:text-emerald-400"
              >
            ...
            <p className="text-sm text-gray-400">
              Stay updated with our latest electric vehicles and exclusive
              offers.
            </p>
          </div>
        </div>
        ...
        <div className="mt-10 border-t border-gray-800 pt-6 text-sm text-gray-400">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-4">
              ...
              <span className="inline-flex items-center gap-1">
                <CreditCard className="h-4 w-4" /> Trusted Payments
              </span>
            </div>
